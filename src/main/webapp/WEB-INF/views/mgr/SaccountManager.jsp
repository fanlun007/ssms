...
<table id="teacherList" title="学生账户查询" class="easyui-datagrid" style="width:auto;height:auto"
       url="studentAccServlet"
       toolbar="#toolbar"
    ...
    <tr>
        ...
        <th field="sno" width="40">学生学号</th>
        <th field="sn" width="90">学生姓名</th>
        <th field="enroll" width="90">入学日期</th>
        <th field="gender" width="90">性别</th>
    </tr>
    </thead>
</table>
...
<div id="toolbar">
    <div>
        <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addTabs('添加班级','addTeacherPage.jsp')">添加学生</a>
        <a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyTeacher()">删除学生</a>
    </div>
</div>
</body>
</html>
